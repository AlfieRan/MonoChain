...
2. [The Consensus protocol "Proof of Worth"](1.4.1-the-protocol/2.5.3-consensus-algorithm/2.5.3.1-proof-of-worth-the-bullet-point-summary..md) is used to cut down on the amount of times each node has to validate transactions from each other node.
...
To learn more about the custom consensus protocol beign hypothesised, I have created a bullet point summary of the theory of how it would work in the file ["1.4.2.1 Proof of Worth - the bullet point summary".](1.4.1-the-protocol/2.5.3-consensus-algorithm/2.5.3.1-proof-of-worth-the-bullet-point-summary..md)
