...
| Test | Instructions                                       | Expected                                        | Actual Result | Pass/Fail |
| ---- | -------------------------------------------------- | ----------------------------------------------- | ------------- | --------- |
| 6    | Navigate to "https://monochain.network/download"   | See updated download instructions               |               |           |
| 7    | Download and unzip the node software               | Should download and unzip to an executable file |               |           |
| 8    | Run the node software on an arm based macOS device | Should run as tested in program tests           |               |           |
