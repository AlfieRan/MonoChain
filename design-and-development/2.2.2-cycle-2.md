...
| ---- | ---------------------------------------------- | ------------------------------------------------------------------------------------ | ----------------- | ------------- |
| 1    | run "v --version" in the terminal              | Output of "V" then some version number and a hash of that update.                    | "V 0.2.4 01fdd5d" | Passed        |
...
#### Test 4 - Starting the program and it outputting a welcome message

![Welcome message displayed alongside an output to declare the server has started](<../.gitbook/assets/image (5).png>)
