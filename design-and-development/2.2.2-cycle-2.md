...
I've changed quite a lot in the whole file, so I'll put the new vs old versions at the bottom of this section, but will go a bit more in depth for the key changes, including how the program is compiled.
