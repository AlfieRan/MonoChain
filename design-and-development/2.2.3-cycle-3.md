...
Most of the development for this cycle went pretty smoothly, especially the configuration handler, there were however some issues with the setup for compiling for multiple OS's but I'll get to that in the specified section.

### The Configuration Handler

This was fairly easy to implement and mostly revolved around turning the general idea and pseudocode I had into V code to run in the program.
...
Once the module was setup I created three files for the code to help separate it out and make it easier for anyone looking at the codebase to see what was going on, the files were:
...
![Compiling for windows](<../.gitbook/assets/image (10).png>)

#### Linux

Linux however, was having absolutely none of it.

![Errors following the linux compilation attempts.](<../.gitbook/assets/image (9).png>)
