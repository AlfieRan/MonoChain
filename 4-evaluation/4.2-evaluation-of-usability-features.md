...
| Question                                                                                                                                                  | Summary of Responses |
| --------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| [Is the website quick and easy to navigate through?](../3-testing/3.2-usability-testing.md#is-the-website-quick-and-easy-to-navigate-through)             |                      |
| [Does the configuration file contain all needed settings?](../3-testing/3.2-usability-testing.md#does-the-configuration-file-contain-all-needed-settings) |                      |
