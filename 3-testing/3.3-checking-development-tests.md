...
{% tabs %}
{% tab title="Test Table" %}
<table><thead><tr><th data-type="number">Test</th><th>Instructions</th><th>Expected Result</th><th data-type="select">Type of Test</th><th>Result</th><th data-type="checkbox">Passed?</th></tr></thead><tbody><tr><td>1</td><td>Send a ping request to "http://nano:8000"</td><td>The requester to successfully complete the ping request.</td><td></td><td>This had to be completed as a handshake event rather than a ping event but still worked as a proof of connection.<img src="../.gitbook/assets/image (21).png" alt=""></td><td>true</td></tr><tr><td>2</td><td>Receive a ping request as "http://nano:8000"</td><td>The receiver to successfully receive and process the request.</td><td></td><td>Same as above</td><td>true</td></tr></tbody></table>
{% endtab %}
