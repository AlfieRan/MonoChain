...
{% tabs %}
{% tab title="Test Table" %}
<table><thead><tr><th data-type="number">Test</th><th>Instructions</th><th>Expected Result</th><th data-type="select">Type of Test</th><th>Result</th><th data-type="checkbox">Passed?</th></tr></thead><tbody><tr><td>1</td><td>Send a ping request to "http://nano:8000"</td><td>The requester to successfully complete the ping request.</td><td></td><td>As Expected </td><td>true</td></tr><tr><td>2</td><td>Receive a ping request as "http://nano:8000"</td><td>The receiver to successfully receive and process the request.</td><td></td><td>As Expected</td><td>true</td></tr></tbody></table>
{% endtab %}
...
{% tabs %}
{% tab title="Test Table" %}
<table><thead><tr><th data-type="number">Test</th><th>Instructions</th><th>Expected Result</th><th></th><th></th><th>Result</th><th data-type="checkbox">Passed?</th></tr></thead><tbody><tr><td>1</td><td>Generate a key pair.</td><td>The program not to exit, which will happen if the key pair cannot be generated.</td><td></td><td></td><td>As Expected</td><td>true</td></tr><tr><td>2</td><td>Generate a key pair and sign some data.</td><td>The program not to exit, which will happen if the key pair cannot be generated or sign the data.</td><td></td><td></td><td>As Expected</td><td>true</td></tr><tr><td>3</td><td>Generate a key pair, sign and then verify some data.</td><td>The program not to exit and to verify that the message matches the signature.</td><td></td><td></td><td>As Expected</td><td>true</td></tr></tbody></table>
{% endtab %}
