...
This question shows that all of the users either agreed or strongly agreed that they knew how to use the website. This is very important since this part of the project is the key part that all of the users needed to know how to use and understand since it acts as the entry point to every other part of the project. Hence this strong of a response shows that the website was very effective and easy to use and as such was successful in it's goal to be a effective entry point to the project.
{% endtab %}
...
Since the website is important for all uses of the project, it is important that the website is quick and easy to navigate through so that users can get to any part of the project or information that they want to get to as efficiently as possible. As shown in the results this was a success, since 40% of the users strongly agreed and 60% of the users agreed meaning that all of the users agreed to some extent that the website is quick and easy to navigate through.
