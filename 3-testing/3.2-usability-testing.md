...
| 18        | Non-technical users must be able to identify what the point/idea of the project is just from the homepage of the website.                                                                     |
| 19        | Users should be able to get to the majority of what they would want to get to within 3 clicks.                                                                                                |
| 20        | The web-portal should be available and working on a variety of device sizes including mobile and desktop.                                                                                     |
